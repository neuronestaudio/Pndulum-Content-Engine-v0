...
|------|-------|----------|----------|----------|--------|------|
| 2026-06-16 | What Your Site Needs In 2026 (direct must-have checklist: pro design, social proof, one clear path, real faces) | Diagnostic (data-led, solution-first) | Airbnb (real photos +40%) + Stanford (75%/94%) + BrightLocal (88%/47%) | 2026 | Built in Canva (reframed from "They Judge You Before You Talk") | https://www.canva.com/d/1lQC2GKFRx9sv08 |
...
| 2026-06-16 | Cut Your CPL in 2026 (3 levers: negatives, Quality Score, landing-page conv.) | Diagnostic (data-led, problem-aware tips) | Google (auction/Quality Score) + WordStream ($70.11 avg CPL) | CPL | Built in Canva (post-03; replaced "Own The EV Driver", which replaced "Clicks Up/Bookings Down") | https://www.canva.com/d/H5-FvLgRlmJuKok |
...
## Watch-outs
- **Speed-to-lead is saturated** — covered heavily by the 5-Minute Rule. Avoid
  re-treading first-response-time as a primary angle.
- Don't reuse the same big-name on consecutive posts unless the angle differs.
